...
},{"vue":33}],33:[function(require,module,exports){
...
},{"_process":28,"timers":29}],34:[function(require,module,exports){
;(function(){
'use strict';
...
var _vueLoadingOverlay = require('vue-loading-overlay');
...
_vue2.default.use(_vueLoadingOverlay2.default);
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('loading',{attrs:{"active":_vm.isLoading,"is-full-page":true},on:{"update:active":function($event){_vm.isLoading=$event}}}),_c('div',{staticClass:"owl-carousel owl-theme"},_vm._l((_vm.pictures),function(picture){return _c('div',{key:picture.index},[_c('a',{attrs:{"href":'https://farm' + picture.farm + '.staticflickr.com/' + picture.server + '/' + picture.id + '_' + picture.secret + '_c.jpg',"alt":picture.title,"target":"_blank"}},[_c('img',{attrs:{"src":'https://farm' + picture.farm + '.staticflickr.com/' + picture.server + '/' + picture.id + '_' + picture.secret + '_z.jpg',"alt":picture.title}}),_c('span',{staticClass:"caption"},[_vm._v(_vm._s(picture.title))])])])}))],1)}
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1d8bff90", __vue__options__)
  } else {
    hotAPI.reload("data-v-1d8bff90", __vue__options__)
  }
})()}
},{"axios":2,"vue":33,"vue-axios":30,"vue-hot-reload-api":31,"vue-loading-overlay":32}],35:[function(require,module,exports){
;(function(){
'use strict';
...
exports.default = {
	...
	data: function data() {
		return {
			cards: [{ english: 'Beer', german: 'Bier', type: 'Cuisine', flipped: false, visible: true }, { english: 'Mountain', german: 'Berg', type: 'Geography', flipped: false, visible: true }, { english: 'Goat', german: 'Ziege', type: 'Animal', flipped: false, visible: true }, { english: 'Street', german: 'Straße', type: 'Transportation', flipped: false, visible: true }, { english: 'River', german: 'Fluss', type: 'Geography', flipped: false, visible: true }, { english: 'Sausage', german: 'Wurst', type: 'Cuisine', flipped: false, visible: true }, { english: 'Knight', german: 'Ritter', type: 'Person', flipped: false, visible: true }, { english: 'Welcome', german: 'Willkommen', type: 'Greeting', flipped: false, visible: true }, { english: 'Island', german: 'Insel', type: 'Geography', flipped: false, visible: true }, { english: 'Tree', german: 'Baum', type: 'Plants', flipped: false, visible: true }, { english: 'Bear', german: 'Bär', type: 'Animal', flipped: false, visible: true }, { english: 'Bridge', german: 'Brücke', type: 'Transportation', flipped: false, visible: true }, { english: 'Sun', german: 'Sonne', type: 'Weather', flipped: false, visible: true }, { english: 'Library', german: 'Bibliothek', type: 'Place', flipped: false, visible: true }, { english: 'Goodbye', german: 'Auf Wiedersehen', type: 'Greeting', flipped: false, visible: true }, { english: 'Flowers', german: 'Blumen', type: 'Plants', flipped: false, visible: true }, { english: 'Nutcracker', german: 'Nussknacker', type: 'Tool', flipped: false, visible: true }, { english: 'Clouds', german: 'Wolken', type: 'Weather', flipped: false, visible: true }, { english: 'Highway', german: 'Autobahn', type: 'Transportation', flipped: false, visible: true }, { english: 'Cheers', german: 'Prost', type: 'Greeting', flipped: false, visible: true }, { english: 'Blackbird', german: 'Amsel', type: 'Animal', flipped: false, visible: true }, { english: 'Rain', german: 'Regen', type: 'Weather', flipped: false, visible: true }, { english: 'City Hall', german: 'Rauthaus', type: 'Place', flipped: false, visible: true }, { english: 'Waterfall', german: 'Wasserfall', type: 'Geography', flipped: false, visible: true }, { english: 'Pipe', german: 'Rohr', type: 'Tool', flipped: false, visible: true }, { english: 'Waitress', german: 'Kellnerin', type: 'Person', flipped: false, visible: true }, { english: 'Icicle', german: 'Eiszapfen', type: 'Tool', flipped: false, visible: true }, { english: 'Chocolate', german: 'Shockolade', type: 'Cuisine', flipped: false, visible: true }],
			type: '',
			visible: true,
			checked: false
		};
	...
	methods: {
		toggleLanguage: function toggleLanguage(card) {
			card.flipped = !card.flipped;
		},
		filterList: function filterList() {
			this.type = event.target.value;
		},
		showCards: function showCards(card) {
	...
	computed: {
		uniqueCardsList: function uniqueCardsList() {
			var types = [];
			this.cards.forEach(function (card) {
